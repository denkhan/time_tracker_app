...
//This is a stateful class where we can add manage the local states(rate per hour and name) inside the class
//Other options were to use ChangeNotifier OR BLoC
...
class _EditJobPageState extends State<EditJobPage> {
  ...
  void initState() {
    super.initState();
    if(widget.job != null && widget.job != null) {
    ...
    if(_validateAndSaveForm()) {
      try {
        ...
        if(allNames.contains(_name)){
          showAlertDialog(context, title: 'Name already used', content: 'Please choose a different job name', defaultActionText: 'OK');
        } else {
  ...
  List<Widget> _buildFormChildren() {
    return [
      TextFormField(
        ...
        initialValue: _name,
        //validator: (value) => value!.isNotEmpty ? null : 'Name can not be empty', This should be used
